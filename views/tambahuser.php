  ...
  <script>
    $(document).ready(function () {
        $("#addUserForm").submit(function (e) {
            ...
            $.ajax({
                url: "../controllers/api.php", // Send to separate API
                type: "POST",
        ...
        //* Fetch pelanggan data and update the table
        function fetchPelangganData() {
            $.ajax({
                url: "../controllers/fetchuser.php", // Create a new PHP file to fetch data from the database
                type: "GET",
                dataType: "json",
                success: function (response) {
                    if (response.success) {
                                ...
                                <td>
                                      <span class="dropdown">
                                          ...
                                          <div class="dropdown-menu dropdown-menu-end">
                                              <a class="dropdown-item" href="#" onclick="editPelanggan(${pelanggan.id})">Edit</a>
                                              <a class="dropdown-item text-danger" href="#" onclick="deletePelanggan(${pelanggan.id})">Delete</a>
                                          </div>
                                      </span>
                                  </td>
                            </tr>`;
                            $("#pelangganTableBody").append(row);
                        });
                    } else {
                      ...
                      success: function (response) {
                          if (response.success) {
                              Swal.fire({
                                  ...
                                  fetchPelangganData(); // Refresh table setelah delete
                              });
                          } else {
                              Swal.fire({
                                  icon: 'error',
        ...
        window.editPelanggan = function(id) {
          $.ajax({
              url: "../controllers/fetchuser.php", // Fetch the data to edit
              type: "GET",
              data: { id: id },
              dataType: "json",
              success: function (response) {
                  if (response.success) {
                      ...
                      $('#editUserModal #nama').val(pelanggan.nama); // Auto-fill name
                      $('#editUserModal #alamat').val(pelanggan.alamat); // Auto-fill address
                      $('#editUserModal #jenis_kelamin').val(pelanggan.jenis_kelamin); // Auto-fill gender
                      $('#editUserModal #tlp').val(pelanggan.tlp); // Auto-fill phone number
                      ...
                      $('#editUserForm').off('submit').on('submit', function (e) {
                          ...
                          // Validate form data
                          const nama = $('#editUserModal #nama').val();
                          const alamat = $('#editUserModal #alamat').val();
                          const jenis_kelamin = $('#editUserModal #jenis_kelamin').val();
                          const tlp = $('#editUserModal #tlp').val();
                          ...
                          $.ajax({
                              url: "../controllers/api.php", // Send to the API for editing
                              type: "POST",
                              data: updatedData,
                              dataType: "json",
                              success: function (response) {
                                  if (response.success) {
                                      Swal.fire({
                                          ...
                                          if (result.isConfirmed) {
                                              ...
                                              fetchPelangganData(); // Refresh the table with updated data
                                          }
                                      });
                                  } else {
                                      Swal.fire({
