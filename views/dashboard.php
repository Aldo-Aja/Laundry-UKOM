        ...
        <div class="page-body">
          <div class="container-xl">
			...
			<div class="card">
				<div class="card-body">
					<?php
                    	$data_outlet = mysqli_query($conn,"SELECT * FROM tb_outlet");
                    	$jumlah_outlet = mysqli_num_rows($data_outlet);
                    ?>
				<div class="d-flex align-items-center">
					<div class="subheader">Outlet</div>
				</div>
				<div class="h1 mb-3"><?php echo $jumlah_outlet; ?></div>
				</div>
			</div>
			</div>

			<!-- Card: Banyak Pesanan (Transaksi) -->
			<div class="col-sm-6 col-lg-3">
			<div class="card">
				<div class="card-body">
					 <?php
                    	$data_transaksi = mysqli_query($conn,"SELECT * FROM tb_transaksi");
                    	$jumlah_transaksi = mysqli_num_rows($data_transaksi);
                    ?>
				<div class="d-flex align-items-center">
					<div class="subheader">Banyak Pesanan</div>
					<div class="ms-auto lh-1">
					</div>
				</div>
				<div class="d-flex align-items-baseline">
					<div class="h1 mb-0 me-2"><?php echo $jumlah_transaksi; ?></div>
				</div>
				</div>
			</div>
			</div>

			<!-- Card: Pelanggan (Member) -->
			<div class="col-sm-6 col-lg-3">
			<div class="card">
				<div class="card-body">
					 <?php
                    	$data_pelanggan = mysqli_query($conn,"SELECT * FROM tb_member");
				...
				<div class="d-flex align-items-baseline">
					<div class="h1 mb-3 me-2"><?php echo $jumlah_pelanggan; ?></div>
				</div>
				</div>
			</div>
			</div>
